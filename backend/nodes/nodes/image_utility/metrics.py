...
@NodeFactory.register("predikit:image:image_metrics")
class ImageMetricsNode(NodeBase):
    """Calculate image quality metrics of modified image."""

    def __init__(self):
        super().__init__()
        self.description = """Calculate image quality metrics (MSE, PSNR, SSIM) between two images."""
        self.inputs = [
    ...
    def run(
        ...
        if (
            ...
            raise AssertionError("Images must have same dimensions and color depth")
