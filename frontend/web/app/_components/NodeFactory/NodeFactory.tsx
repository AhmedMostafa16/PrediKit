...
import { BaseNode } from "../../_nodes/BaseNode";
          ...
          props.inputHandles.map((item, index) => (
            <Handle
              ...
              style={{
                left: -16,
                top:
                  32 / props.inputHandles.length +
                  (index * 64) / props.inputHandles.length,
          ...
          props.outputHandles.map((item, index) => (
            <Handle
              ...
              style={{
                right: -16,
                top:
                  32 / props.outputHandles.length +
                  (index * 64) / props.outputHandles.length,
                background: "var(--mantine-color-gray-6)",
                borderColor: "var(--mantine-color-gray-6)",
                borderRadius: "0 50% 50% 0",
                borderWidth: 4,
