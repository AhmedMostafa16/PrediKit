...
export function ItemsGroup({ color, label, initiallyOpened, items }: ItemsGroupProps) {
    ...
    <React.Fragment key={item.label}>
      <Group justify="space-between" gap={0}>
        <Text<'a'>
          ...
          onDragStart={(event: React.DragEvent<HTMLAnchorElement>) => onDragStart(event, item)}
          draggable
        >
