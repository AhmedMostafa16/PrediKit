...
import { PrediKitDragData, TransferTypes } from "../../helpers/dataTransfer";
...
const onDragStart = (event: DragEvent<HTMLDivElement>, node: NodeSchema) => {
    const data: PrediKitDragData = {
        schemaId: node.schemaId,
        offsetX: event.nativeEvent.offsetX,
        offsetY: event.nativeEvent.offsetY,
    };

    event.dataTransfer.setData(TransferTypes.PrediKitSchema, JSON.stringify(data));
